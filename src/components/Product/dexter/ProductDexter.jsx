  ...
  return (
    <div className="divProduct">
      ...
      <div className="infoProduct">
        <h1>
          {productData[0] != undefined ? productData[0].title : SkeletonTitle()}
        </h1>
        <p className="price">
          {productData[0] != undefined
          ...
          >
            Comprar{" "}
            {
              <img
                ...
                src="https://www.dexter.com.ar/on/demandware.static/Sites-Dexter-Site/-/default/dwd1e87af2/images/logo.svg"
                alt=""
              />
            }
          </button>
